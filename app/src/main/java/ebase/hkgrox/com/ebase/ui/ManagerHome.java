...
public class ManagerHome extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setNavigationDrawer() {
        ...
        /*navName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagerHome.this,ProfileActivity.class);
                startActivity(intent);
        ...
        navChangePassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagerHome.this, Products.class);
                startActivity(intent);
                drawer.closeDrawer(GravityCompat.START);
            }
        });
        navAbout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagerHome.this, AboutUs.class);
        ...
        navContactUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagerHome.this, ContactUs.class);
                startActivity(intent);
                drawer.closeDrawer(GravityCompat.START);
            }
        });
        nav_enquiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagerHome.this, Enquiry.class);
                intent.putExtra(AppUtil.DATA,user);
                startActivity(intent);
                drawer.closeDrawer(GravityCompat.START);
            }
        ...
        couponGifts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManagerHome.this, CouponGifts.class);
                // intent.putExtra(AppUtil.DATA,user);
                startActivity(intent);
                drawer.closeDrawer(GravityCompat.START);
            }
    ...
    public void onClick(View v) {
        ...
        if (v == add) {
           ...
           /* // Handle clicks for btnAddCoupon
            ...
            etCoupon.setText("");
            btnAddCoupon.setVisibility(View.GONE);*/
            Intent intent = new Intent(this,ManagersSale.class);
            intent.putExtra("DATA", user);
            startActivity(intent);
            ...
            if (isValid()) {
  /*              MUtil.showProgressDialog(ManagerHome.this);
                DatabaseReference databaseReferencenew = AppUtil.getCouponReference(ManagerHome.this).child(etCoupon.getText().toString().toUpperCase());
                databaseReferencenew.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (coupon == null) {
                            MUtil.showInfoAlertDialog(ManagerHome.this, "Coupon invalid try with another coupon");
                            MUtil.dismissProgressDialog();
                        } else {
                            if(isExpired(coupon.getValid_til())){
                                MUtil.showInfoAlertDialog(ManagerHome.this, "Coupon expired try with another coupon");
                                MUtil.dismissProgressDialog();
                            }else{
                                if(coupon.getIs_availed().equalsIgnoreCase("yes")){
                                    MUtil.showInfoAlertDialog(ManagerHome.this, "Coupon availed try with another coupon");
                                    MUtil.dismissProgressDialog();
                                }else{
                                    addPoints(coupon);
                                }
...
*/
    ...
    private void addPoints(final COUPON coupon) {
        ...
        DatabaseReference databaseReference = AppUtil.getUserReference(ManagerHome.this);
        ...
        databaseReference.child(user.getMOBILE()).setValue(user, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                if (databaseError != null) {
                    MUtil.showSnakbar(ManagerHome.this, "Coupon addition failed try again ");
                    MUtil.dismissProgressDialog();
                } else {
                    updateCoupon(coupon);
                }
    ...
    private void updateCoupon(COUPON coupon) {
        ...
        DatabaseReference databaseReference = AppUtil.getCouponReference(ManagerHome.this);
        databaseReference.child(etCoupon.getText().toString().toUpperCase()).setValue(coupon, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                if (databaseError != null) {
                    ...
                    MUtil.showSnakbar(ManagerHome.this, "Coupon added successfully.");

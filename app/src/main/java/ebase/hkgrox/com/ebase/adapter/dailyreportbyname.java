...
/**
 * Created by Zooom HKG on 1/22/2018.
 */

public class dailyreportbyname extends RecyclerView.Adapter<dailyreportbyname.Myholder> {

    List<Vender> list;
    Context context;

    public dailyreportbyname(Context context, List<Vender> list) {
        this.list = list;
    ...
    public Myholder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.row_dailyreport,parent,false);
    ...
    public void onBindViewHolder(Myholder holder, int position) {
       ...
       // holder.status.setText(report.getStatus());
        ...
        holder.checkoutdate.setText(report.getDate());
   }
    ...
    public static class Myholder extends RecyclerView.ViewHolder {
        ...
        TextView ename,ephone,checkindate,checkoutdate,party,ret,seg,contp,phone,potpm,order,status,address,area,city,pi,remark,mobile2,orderdt,checkin,checkout,email,time,checkintime;
        public Myholder(View itemView) {
            super(itemView);
            ename=(TextView)itemView.findViewById(R.id.employeename);
            ephone=(TextView)itemView.findViewById(R.id.employeephone);
            checkindate=(TextView)itemView.findViewById(R.id.checkindate);
            checkoutdate=(TextView)itemView.findViewById(R.id.checkoutdae);
          ...
          //  status=(TextView)itemView.findViewById(R.id.status);
            ...
            orderdt=(TextView) itemView.findViewById(R.id.orderdetails);

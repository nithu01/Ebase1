...
public class Indivisual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            MUtil.setToolBarNew(this, "Daily Individual Report", true);
        ...
        call.enqueue(new Callback<List<USER>>() {
            ...
            public void onResponse(Call<List<USER>> call, Response<List<USER>> response) {
                ...
                et_name.setAdapter(new MyAdapter(Indivisual.this,day_sales));
        ...
        databaseReferencenew.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (!user.getDEGINATION().equalsIgnoreCase("admin")) {
        ...
        btn_get_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_name.getSelectedItemPosition()==0){
                    MUtil.showInfoAlertDialog(Indivisual.this,"Please Select user first.");
                }else{
    ...
    private void startHomeActivity(USER user) {
        ...
        if (user.getDEGINATION().toLowerCase().contains("executive")) {
            intent = new Intent(this, ExecutivesSale.class);
        }
        if(user.getDEGINATION().toLowerCase().contains("manager")){
            intent = new Intent(this, ManagersSale.class);
        }
        ...
        if(intent!=null) {
           ...
           // finish();
            ...
            MUtil.showInfoAlertDialog(Indivisual.this,"Something went wrong try again");
        }

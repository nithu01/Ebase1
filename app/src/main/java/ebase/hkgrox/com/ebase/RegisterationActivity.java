...
import ebase.hkgrox.com.ebase.ui.HomePageActivity;
import ebase.hkgrox.com.ebase.ui.LoginActivity;
import ebase.hkgrox.com.ebase.ui.MainActivity;
import ebase.hkgrox.com.ebase.ui.UserHome;
...
public class RegisterationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    String[] usertype = { "Select type","Distributor", "Workshop Owner", "Premium Retailer" };
...
//                    user.setTODAY_MST(today_mst);
                ...
                dis_type.setAdapter(new MyAdapter(RegisterationActivity.this,day_sales));
...
//            Toast.makeText(MainActivity.this,""+user_type.getSelectedItem().toString(),Toast.LENGTH_SHORT).show();
            if (isValid()) {
               // Toast.makeText(RegisterationActivity.this,""+datee,Toast.LENGTH_SHORT).show();
                ...
                MUtil.showProgressDialog(RegisterationActivity.this);
               // Toast.makeText(RegisterationActivity.this,""+datee,Toast.LENGTH_SHORT).show();
                Retrofit retrofit=new Retrofit.Builder().baseUrl(login_url2).addConverterFactory(GsonConverterFactory.create()).build();
                Addvender addvender=retrofit.create(Addvender.class);
                Call<List<USER>> call=addvender.inser(datee,name,city,mobile,address,email,password,pincode,state,user_type.getSelectedItem().toString(),dis_type.getSelectedItem().toString());
                call.enqueue(new Callback<List<USER>>() {
                    @Override
                    public void onResponse(Call<List<USER>> call, Response<List<USER>> response) {
    ...
    private void registered() {
        ...
        DatabaseReference databaseReference = AppUtil.getUserReference(RegisterationActivity.this);
        ...
        databaseReference.child(user.getMOBILE()).setValue(user, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                if (databaseError != null) {
                    MUtil.showSnakbar(RegisterationActivity.this, "User creation failed try again ");
                } else {
                    MUtil.showSnakbar(RegisterationActivity.this, "User created successfully.");
//                    startHomeActivity(user,);
    ...
    private boolean isValid() {
        ...
        if(user_type.getSelectedItem().toString().equals("Select type")){
            MUtil.showSnakbar(this,"Select type");
            return false;
        }else if(dis_type.getVisibility()==View.VISIBLE && dis_type.getSelectedItem().toString().equals("Select Distributor")){
            MUtil.showSnakbar(this,"Select distributor");
            return false;
        }
        return true;
    }
    ...
    class Backgroundtask extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            MUtil.dismissProgressDialog();
            MUtil.showSnakbar(RegisterationActivity.this, "User created successfully.");
            Intent intent = new Intent(RegisterationActivity.this, HomePageActivity.class);
            startActivity(intent);
            finish();

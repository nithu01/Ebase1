...
public class CouponAdminUserDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout=findViewById(R.id.total_point_layout);
        ...
        txt_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CouponAdminUserDetail.this, Coupondetails.class).putExtra("DATA",user.getNAME()));
            }
        });
        ...
        if(user.getDEGINATION().equals("Premium Retailer")){
            ...
            Call<List<COUPON>> call=userCouponApi.newreport(phn);
...
//                        .subscribe(this::handleResponse,this::handleError));
      //  Toast.makeText(CouponAdminUserDetail.this,""+user.getMOBILE(),Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<List<CurrentPointResponse>>() {
            ...
            public void onResponse(Call<List<CurrentPointResponse>> call, Response<List<CurrentPointResponse>> response) {
                   //Toast.makeText(CouponAdminUserDetail.this,""+response.body().size(),Toast.LENGTH_SHORT).show();
                try{
            ...
            public void onFailure(Call<List<CurrentPointResponse>> call, Throwable t) {
                Toast.makeText(CouponAdminUserDetail.this,""+t,Toast.LENGTH_SHORT).show();
